...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      $message[] = 'Email ou senha incorrectas!';
   }
...
<div class="form-container">
   ...
   <img src="images/444.jpg" class="img-responsive" id="logo" alt="responsive image"><br>
      ...
      <p>Nao tens uma conta? <a href="register.php">Criar conta</a></p>
   </form>
